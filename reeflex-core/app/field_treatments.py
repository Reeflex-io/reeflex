...
TREATMENTS: dict[str, Treatment] = {
    ...
    # F9 the RFX-86 hole would have reopened one field over.
    "target.ref": Treatment(
        CANONICALISE, "envelope.canonicalize_target_ref (F9)",
        ...
        note="Read by R6 (protected.rego) as a PREFIX against the operator's "
             ...
             "member, but there is no most-guarded PATH to coerce to, so F9 is "
